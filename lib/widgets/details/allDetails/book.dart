                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Align(
                          child: Text(
                            'Please Show your voucher details',
                            style: TextStyle(
                              color: Colors.black,
                            ),
                          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            alignment: Alignment.centerLeft,
            child: Text('Product is good but shipping is delayed'),
          ),
          Container(
            child: GridView(
              shrinkWrap: true,
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.network(
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQERcI15AoXGqpatsyjID7HO8EGzeQcwfW7pA&usqp=CAU',
                    height: 100,
                    fit: BoxFit.cover,
                  ),
                ),
